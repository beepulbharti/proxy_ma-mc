...
def load_ACSIncome_no_sex(states=['CA'], groups='all'):
    '''
    ACSIncome dataset, without biological sex features.
    sex-dependent groups added, however.
    '''
    return load_ACSIncome(states, drop_features=['SEX'],
                          groups=groups)

def load_ACSIncome_no_race(states=['CA'], groups='all'):
    '''
...
def load_ACSIncome_no_sex_and_race(states=['CA'], groups='all'):
    '''
    ACSIncome dataset, without race features.
    Race-dependent groups added, however.

    '''
    return load_ACSIncome(states, drop_features=['SEX','RAC1P'],
                          groups=groups)

def load_ACSIncome(states=['NY'], drop_features=[], groups='default'):
    '''
